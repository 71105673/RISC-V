...
HD_PWD='D:/CPU_workspace/APB_UART/APB_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MCU.tcl -notrace
