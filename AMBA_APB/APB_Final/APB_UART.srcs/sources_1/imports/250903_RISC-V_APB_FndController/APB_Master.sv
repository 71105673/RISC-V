...
module APB_Master (
    ...
    input  logic [31:0] PRDATA5,    // UART_FIFO
    ...
    always_comb begin
        ...
        if (en) begin
            casex (sel)
                ...
                32'h1000_4xxx: y = 6'b010000;   // FND
                32'h1000_5xxx: y = 6'b100000;   // UART
            endcase
        end
    end
